...
# Állítsuk be a munkakönyvtárat. \ jelet használjunk a könyvtár szintek elválasztásához. A program itt keresi atehenek adatait tartalmazó
# csv fájlt, a modell leírását tartalmaz stan fájlt és ide menti az eredményeket
  setwd("C:/Users/Veres Katalin/Desktop/Phd/PTBC_2021/Selected/Alapmodell/harmadik")
...
LData =
  ...
  # fájlnév!
  PTBC_fit = stan('PTBC_egytelep_magyar_20240126.stan', data=LData, chains=4, iter=20000, control = list(adapt_delta = 0.99,stepsize=0.1), seed = 1085417771)#, control = list(adapt_delta = 0.99, stepsize=0.1))
